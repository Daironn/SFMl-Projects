	...
	for (int i = 0; i < 3; i++) {
		...
		for (int j = 0; j < 4; j++) {
			...
			if (i != 1) {
				...
				checkerArrayInfoRED[checkerArrayREDInt].checkerID = checkerArrayREDInt;
...
void Checker::draw(sf::RenderWindow & window)
{
	for (int i = 0; i < checkerArrayRED.size(); i++) {
		...
		if (!checkerArrayInfoRED[i].killed) {
	...
	for (int i = 0; i < checkerArrayBLACK.size(); i++) {
		...
		if (!checkerArrayInfoBLACK[i].killed) {
								...
								if ((!BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].ifContainpawn && !BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 18].ifContainpawn)
									...
									if (BoardObject.squareArray[checkerArrayInfoBLACK[i].onWhatSquare + 18].getGlobalBounds().contains(mousePos)) {
										...
										if (sf::Mouse::isButtonPressed(sf::Mouse::Left)) {
											...
											if (!BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].isItBLACK) {

												checkerArrayInfoRED[*BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].checkerIDBLACK].killed = true;
												checkerArrayRED[*BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].checkerIDRED].setPosition(9000, 9000);
								...
								if ((!BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 7].ifContainpawn && !BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 14].ifContainpawn)
									...
									if (BoardObject.squareArray[checkerArrayInfoBLACK[i].onWhatSquare + 14].getGlobalBounds().contains(mousePos)) {
										...
										if (sf::Mouse::isButtonPressed(sf::Mouse::Left)) {
											...
											if (!BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 7].isItBLACK) {

												checkerArrayInfoRED[*BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 7].checkerIDRED].killed = true;
												checkerArrayRED[*BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 7].checkerIDRED].setPosition(9000, 9000);
												BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 7].killed = true;
												BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 7].ifContainpawn = false;
												BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 7].isItBLACK = false;
												BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 7].isItRED = false;
											}
									...
									if (BoardObject.squareArray[checkerArrayInfoBLACK[i].onWhatSquare + 18].getGlobalBounds().contains(mousePos)) {
										...
										if (sf::Mouse::isButtonPressed(sf::Mouse::Left)) {
											...
											if (!BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].isItBLACK) {
												...
												checkerArrayInfoRED[*BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].checkerIDRED].killed = true;
												checkerArrayRED[*BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].checkerIDRED].setPosition(9000, 9000);
												BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].killed = true;
												BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].ifContainpawn = false;
												BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare + 9].isItBLACK = false;
				...
				if (checkerArrayInfoRED[i].tagged == true) {
					...
					if (!checkerArrayInfoBLACK[i].killed) {
						...
						if (BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare].line == 0) {
							...
							if (BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare].row > 1) {

								if ((!BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 7].ifContainpawn && !BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 14].ifContainpawn)
									|| (!BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 7].ifContainpawn && BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 14].ifContainpawn)) {
								...
								else if (BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 7].ifContainpawn && !BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 14].ifContainpawn && !BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 7].isItRED) {

									BoardObject.squareArray[checkerArrayInfoRED[i].onWhatSquare - 14].setFillColor(sf::Color::Green);

									BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 14].ableToTake = true;

									if (BoardObject.squareArray[checkerArrayInfoRED[i].onWhatSquare - 14].getGlobalBounds().contains(mousePos)) {

										if (sf::Mouse::isButtonPressed(sf::Mouse::Left)) {

											checkerArrayRED[i].setPosition(BoardObject.squareArray[checkerArrayInfoRED[i].onWhatSquare - 14].getPosition().x + 12,
												BoardObject.squareArray[checkerArrayInfoRED[i].onWhatSquare - 14].getPosition().y + 12);

											BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 14].ifContainpawn = true;
											BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare].ifContainpawn = false;
											...
											BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 14].isItRED = true;
											BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare].isItRED = false;
							...
							else if (BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare].row == 1) {
								...
								else if ((!BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 9].ifContainpawn && !BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 18].ifContainpawn)
									|| (!BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 9].ifContainpawn && BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 18].ifContainpawn)) {
							...
							else if (BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare].row == 0) {

								checkerArrayInfoRED[i].typeQueen = true;
						...
						//end of left side
							...
							if (BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare].row > 1) {
								...
								if ((!BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 9].ifContainpawn && !BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 18].ifContainpawn)
									|| (!BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 9].ifContainpawn && BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 18].ifContainpawn)) {
								...
								else if ((!BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 7].ifContainpawn && !BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 14].ifContainpawn)
									|| (!BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 7].ifContainpawn && BoardObject.squareArrayInfo[checkerArrayInfoRED[i].onWhatSquare - 14].ifContainpawn)) {
						...
						//end of right side
							...
							if (BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare].row > 1) {
							...
							else if (BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare].row == 1) {
							...
							else if (BoardObject.squareArrayInfo[checkerArrayInfoBLACK[i].onWhatSquare].row == 0) {
